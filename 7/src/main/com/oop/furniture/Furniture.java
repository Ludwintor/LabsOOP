...
public class Furniture {
  ...
  public boolean equals(Object o) {
    ...
    return cost == furniture.cost && Float.compare(furniture.weight, weight) == 0 && Objects.equals(name, furniture.name) && Objects.equals(material, furniture.material);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cost, weight, name, material);
  }
}
